        ...
        <div class="col-lg-12" style="min-height:400px;">
          ...
          <tbody>
            <tr>
              ...
              <td> <a href="ApproveComments.php?id=<?php echo $CommentId;?>" class="btn btn-primary">Approve</a>  </td>
              <td> <a href="DeleteComments.php?id=<?php echo $CommentId;?>" class="btn btn-primary">Delete</a>  </td>
          ...
          <tbody>
            <tr>
              ...
              <td style="min-width:140px;"> <a href="DisApproveComments.php?id=<?php echo $CommentId;?>" class="btn btn-light">Dis-Approve</a>  </td>
              <td> <a href="DeleteComments.php?id=<?php echo $CommentId;?>" class="btn btn-light">Delete</a>  </td>
              <td style="min-width:140px;"> <a class="btn btn-primary"href="FullPost.php?id=<?php echo $CommentPostId; ?>" target="_blank">Live Preview</a> </td>
            </tr>
          </tbody>
          <?php } ?>
